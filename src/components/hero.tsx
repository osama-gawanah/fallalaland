      ...
      <BlurFade delay={BLUR_FADE_DELAY * 2}>
        <div className=" md:-mt-12 mb-10">
          <div className="flex justify-between items-center">
            ...
            <nav className="hidden md:flex items-center gap-8">
              {navigationLinks.map((link) => (
                <a
                  ...
                  className={cn(
                    "font-medium transition-colors hover:text-[#581e97]",
            ...
            <div className="hidden relative !z-[1000]" ref={menuRef}>
              <Button
                variant="ghost"
                size="icon"
              ...
              {isMenuOpen && (
                <motion.div
                  ...
                  exit={{ opacity: 0, y: -10 }}
                  className="absolute right-0 z-50 top-full mt-2 w-48 bg-background border border-border rounded-lg shadow-lg"
                >
                  <nav className="flex flex-col p-2">
                    {navigationLinks.map((link) => (
                      <a
                        ...
                        className={cn(
                          "px-4 py-2 text-sm font-medium transition-colors hover:text-[#581e97] hover:bg-accent rounded-md",
                          "text-muted-foreground"
                        )}
                      >
                        {link.label}
